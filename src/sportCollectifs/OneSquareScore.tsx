            ...
            <div className="flex justify-center w-[98%] border-b-2">
                <div className="flex justify-between p-2 pr-0 w-[98%]">
                    ...
                    <div className="flex items-center">
                        {statut.type === 'encours' && <span className="font-semibold">{statut.periode}</span>}
                        {statut.type === 'termine' && statut.libelle && (
                            <span className="font-semibold">{statut.libelle}</span>
                        )}
                        <ScoreColumDisplay
                            key={'SCERD-2'}
